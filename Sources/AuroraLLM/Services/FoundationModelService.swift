...
/// configuration properties (`name`, `systemPrompt`, `defaultModel`, etc.).
///
/// **Safe Usage Pattern:**
...
/// service.systemPrompt = "..."  // ✅ Before sharing
...
public class FoundationModelService: LLMServiceProtocol, @unchecked Sendable {
